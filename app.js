        ...
        squares[i].addEventListener('click', function(){
            ...
            if (squares[index + 7].classList.contains('taken')){
                if ((squares[index].classList.contains('player-one')) || (squares[index].classList.contains('player-two'))){
                    ...
                    displayCurrentPlayer.classList.remove('red')
                    displayCurrentPlayer.classList.add('blue')
                    ...
                    currentPlayer = 1
                    displayCurrentPlayer.innerHTML = currentPlayer
                    displayCurrentPlayer.classList.remove('blue')
                    displayCurrentPlayer.classList.add('red')
